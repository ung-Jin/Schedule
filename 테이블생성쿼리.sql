...
CREATE TABLE MEMBER (
                        ...
                        MEM_information_schemainformation_schema`project-1`PW VARCHAR(100) NOT NULL,
...
##고장접수##
-- ========================================
-- 3. REQUEST (신청 10건) (RECEIVED/ASSIGNED/IN_PROGRESS/COMPLETED)
-- ========================================
...
(1,  '홍길동', '010-9936-5962', '울산광역시 중구 태화로 201',           '에어컨',        '냉방이 전혀 안 됨',       '2026-09-15 14:00:00', 'RECEIVED',    7),
(2,  '김철수', '010-9936-5962', '울산광역시 중구 번영로 329',           '보일러',        '온수가 안 나옴',          '2026-09-16 10:00:00', 'RECEIVED',    8),
(3,  '이영희', '010-9936-5962', '울산광역시 남구 삼산로 273',           '스탠드형 에어컨', '혼자 자꾸 넘어짐',        '2026-09-17 13:00:00', 'ASSIGNED',    9),
(4,  '박민수', '010-9936-5962', '울산광역시 남구 돋질로 233',           '에어컨',        '실외기에서 이상한 소리',   '2026-09-18 09:00:00', 'ASSIGNED',    10),
(5,  '최지우', '010-9936-5962', '울산광역시 동구 봉수로 155',           '보일러',        '전원이 안 켜짐',          '2026-09-12 11:00:00', 'COMPLETED',   11),
(6,  '정하늘', '010-9936-5962', '울산광역시 동구 방어진순환도로 1000',  '라디에이터',     '물이 새어 나옴',          '2026-09-19 15:00:00', 'RECEIVED',    12),
(7,  '강나연', '010-9936-5962', '울산광역시 북구 산업로 1426',          '에어컨',        '바람이 미지근함',         '2026-09-20 16:00:00', 'RECEIVED',    13),
(8,  '조현우', '010-9936-5962', '울산광역시 북구 호계로 300',           '보일러',        '에러코드 E03 표시',       '2026-09-14 09:30:00', 'IN_PROGRESS', 14),
(9,  '윤서연', '010-9936-5962', '울산광역시 울주군 범서읍 구영로 100',  '시스템 에어컨',  '전원이 아예 안 들어옴',    '2026-09-26 10:00:00', 'ASSIGNED',    15),
(10, '임도윤', '010-9936-5962', '울산광역시 울주군 언양읍 읍성로 830',  '에어컨',        '필터 청소 후에도 냄새남', '2026-09-22 14:30:00', 'RECEIVED',    16);

UPDATE REQUEST
SET CUSTOMER_TEL = '010-9936-5962'
WHERE REQUEST_NO BETWEEN 1 AND 13;
COMMIT;
SELECT * FROM request;
...
-- ========================================
INSERT INTO AS_RESULT (RESULT_NO, SCHEDULE_NO, PROCESS_DATE, PROCESS_CONTENT, RESULT_STATUS, NO_PHOTO_REASON) VALUES
    (1, 3, '2026-09-12 13:00:00', '보일러 점화플러그 교체 후 정상 작동 확인', '완료', '촬영을 깜빡함');
...
INSERT INTO REQUEST (REQUEST_NO, CUSTOMER_NAME, CUSTOMER_TEL, CUSTOMER_ADDR, PRODUCT_TYPE, SYMPTOM, WISH_DATE, STATUS, MEM_NO) VALUES
                                                                                                                                   (11, '홍길동', '010-9936-5962', '울산광역시 중구 태화로 201',           '에어컨',    '리모컨 조작이 안 먹음',      '2026-09-15 10:00:00', 'ASSIGNED',    7),
                                                                                                                                   (12, '박민수', '010-9936-5962', '울산광역시 남구 돋질로 233',           '에어컨',    '실내기에서 물이 떨어짐',     '2026-09-15 13:00:00', 'IN_PROGRESS', 10),
                                                                                                                                   (13, '정하늘', '010-9936-5962', '울산광역시 동구 방어진순환도로 1000',  '라디에이터', '작동은 되나 소음이 심함',    '2026-09-15 09:00:00', 'COMPLETED',   12);


-- 7-2. 위 REQUEST에 대응하는 오늘자 AS_SCHEDULE (전부 ENGINEER_NO=1 김기술)
INSERT INTO AS_SCHEDULE (SCHEDULE_NO, REQUEST_NO, ENGINEER_NO, FIX_DATE, START_TIME, END_TIME, STATUS) VALUES
                                                                                                           (6, 11, 1, '2026-09-15', '2026-09-15 10:00:00', '2026-09-14 11:00:00', 'ASSIGNED'),
                                                                                                           (7, 12, 1, '2026-09-15', '2026-09-15 13:00:00', '2026-09-14 14:30:00', 'IN_PROGRESS'),
                                                                                                           (8, 13, 1, '2026-09-15', '2026-09-15 09:00:00', '2026-09-14 09:40:00', 'COMPLETED');


-- 7-3. 완료된 건(SCHEDULE_NO 8)의 처리 결과

INSERT INTO AS_RESULT (RESULT_NO, SCHEDULE_NO, PROCESS_DATE, PROCESS_CONTENT, RESULT_STATUS, NO_PHOTO_REASON) VALUES
(2, 8, '2026-09-14 09:40:00', '순환펌프 브라켓 조임 후 소음 해결, 정상 작동 확인', '완료', '단순 설정/원격 조치로 사진이 필요 없음');
